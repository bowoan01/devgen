    ...
    <div class="d-flex">
        <aside class="bg-white border-end min-vh-100 shadow-sm" style="width: 260px;">
            <div class="p-4 border-bottom">
                <a href="/admin" class="fs-4 fw-semibold text-decoration-none text-primary">Devengour Admin</a>
            </div>
            <nav class="p-4">
        ...
        <div class="flex-fill">
            <header class="bg-white border-bottom py-3 px-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0 small">Manage the content powering Devengour.com</p>
                </div>
