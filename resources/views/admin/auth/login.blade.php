...
<head>
    ...
    <title>Sign in — Devengour Admin</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="card border-0 shadow-xl rounded-4 overflow-hidden">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <h1 class="h3 fw-semibold mb-1 text-primary">Devengour Admin</h1>
                        ...
                        <form id="login-form" action="/login" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" class="form-control form-control-lg rounded-3" placeholder="admin@devengour.com" required autofocus>
                            </div>
                            <div class="mb-3">
                ...
                <p class="text-center text-white-50 mt-4">© {{ date('Y') }} Devengour. Crafted for excellence.</p>
            </div>
        </div>
    </div>
