        ...
        <div class="row gy-4">
            <div class="col-lg-4">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="https://www.dribbble.com" class="text-white-50" target="_blank" rel="noopener">Dribbble</a>
                    <a href="https://www.behance.net" class="text-white-50" target="_blank" rel="noopener">Behance</a>
                </div>
            </div>
            <div class="col-lg-3 offset-lg-1">
                <h5 class="fw-semibold">Explore</h5>
                <ul class="list-unstyled opacity-75">
                    <li class="mb-2"><a class="text-white-50 text-decoration-none" href="/services">Services</a></li>
                    <li class="mb-2"><a class="text-white-50 text-decoration-none" href="/portfolio">Portfolio</a></li>
                    <li class="mb-2"><a class="text-white-50 text-decoration-none" href="/about">About</a></li>
