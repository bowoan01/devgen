...
@section('content')
    <section class="container py-7" data-animate="fade-up">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <div class="d-flex flex-wrap gap-3 mt-4">
                    <a href="/contact" class="btn btn-primary btn-lg rounded-pill px-4 shadow button-soft-transition">Let’s
                        Build Together</a>
                    <a href="/portfolio"
                        class="btn btn-outline-primary btn-lg rounded-pill px-4 button-soft-transition">Explore our work</a>
                </div>
            ...
            <div class="col-lg-6">
                <div class="hero-visual rounded-5 shadow-lg overflow-hidden position-relative image-zoom"
                    data-animate="zoom-in">
                    <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=1080&q=80"
                        class="img-fluid" alt="Team collaborating">
                    <div class="position-absolute bottom-0 start-0 end-0 p-4 bg-gradient-dark text-white">
                        <p class="mb-0 fw-medium">“Devgenfour orchestrated the entire product launch with elegance and
                            precision.”</p>
    ...
    <section class="bg-white py-6" data-animate="fade-up">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                ...
                <a href="/services" class="btn btn-outline-primary rounded-pill button-soft-transition">All services</a>
            </div>
            <div class="row g-4" data-stagger>
                @foreach ($services as $service)
                    <div class="col-md-6 col-xl-3">
                        <div class="card h-100 border-0 shadow-sm rounded-4 service-card hover-elevate"
                            data-animate="fade-up">
                            <div class="card-body p-4">
                                <div class="icon-placeholder mb-3"><i
                                        class="{{ $service->icon_class ?? 'bi bi-stars' }} text-primary fs-2"></i></div>
                                <h3 class="h5 fw-semibold">{{ $service->title }}</h3>
                                <p class="text-muted">{{ $service->excerpt }}</p>
                                <a href="/services/{{ $service->slug }}"
                                    class="stretched-link text-decoration-none">Discover more →</a>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <section class="container py-6" data-animate="fade-up">
        ...
        <div class="row g-4" id="home-portfolio" data-lightgallery data-stagger>
    ...
    <section class="bg-gradient-azure text-white py-6" data-animate="fade-up">
        <div class="container">
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    <h2 class="display-6 fw-semibold">We’re a team of thinkers, designers, and engineers united by craft.
                    </h2>
                    <p class="lead text-white-50">From strategy to ship, Devgenfour partners with ambitious organisations to
                        deliver premium digital products.</p>
                    <a href="/about" class="btn btn-light btn-lg rounded-pill button-soft-transition">Meet the team</a>
                </div>
                <div class="col-lg-5">
                    <div class="row g-3">
                            ...
                            <div class="col-6">
                                <div class="bg-white text-dark rounded-4 p-3 shadow-sm h-100">
                                    <div class="ratio ratio-1x1 rounded-4 overflow-hidden mb-3">
                                        <img src="{{ $member->photo_path ? asset('storage/' . $member->photo_path) : 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39?auto=format&fit=crop&w=400&q=80' }}"
    ...
    <section class="container py-7" data-animate="fade-up">
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <p class="text-muted fs-5">Tell us about your vision and we’ll assemble a dream team to launch it. We
                    respond within one business day.</p>
                <div class="d-flex gap-3">
                    <a href="/contact" class="btn btn-primary btn-lg rounded-pill">Start a project</a>
                    <a href="mailto:hello@Devgenfour.com"
                        class="btn btn-outline-primary btn-lg rounded-pill">hello@Devgenfour.com</a>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="rounded-5 shadow-lg overflow-hidden image-zoom">
                    <img src="https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?auto=format&fit=crop&w=900&q=80"
                        class="img-fluid" alt="Workspace">
                </div>
            </div>
        </div>
    </section>
