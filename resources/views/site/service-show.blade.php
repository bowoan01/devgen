            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 mb-4 hover-elevate" data-animate="fade-up">
                    <div class="card-body p-4">
                        ...
                        <a href="/contact" class="btn btn-primary w-100 rounded-pill mt-3 button-soft-transition">Book a discovery call</a>
                    </div>
                </div>
                <div class="card border-0 shadow-sm rounded-4 hover-elevate" data-animate="fade-up">
                    <div class="card-body p-4">
                        ...
                        <a href="/portfolio" class="btn btn-outline-primary btn-sm rounded-pill button-soft-transition">View portfolio</a>
                    </div>
                </div>
            </div>
        </div>
