    ...
    <div class="container">
        <div class="row g-5" data-animate="fade-up">
            <div class="col-lg-5">
                ...
                <div class="ratio ratio-16x9 rounded-4 overflow-hidden shadow-sm image-zoom" data-animate="zoom-in">
                    {!! $mapEmbed !!}
                </div>
            </div>
            <div class="col-lg-7">
                <div class="card border-0 shadow-lg rounded-4 hover-elevate" data-animate="fade-up">
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <form id="contact-form" action="/contact" method="POST">
                            ...
                            <div class="d-grid d-sm-flex justify-content-sm-end gap-3 mt-4">
                                <button type="reset" class="btn btn-outline-secondary rounded-pill px-4 button-soft-transition">Reset</button>
                                <button type="submit" class="btn btn-primary rounded-pill px-4 button-soft-transition">Send message</button>
                            </div>
